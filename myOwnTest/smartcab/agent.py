...
#         key = self.Q.get(key2)
    ...
    def choose_action(self, state,waypoint, aRandomChoice):
        import random
    ...
    def update(self):
        ...
        self.createQ(state, waypoint,randomChoice)                 # Create 'state' in Q-table
        action = self.choose_action(state,waypoint,randomChoice)  # Choose an action
